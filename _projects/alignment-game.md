...
At work as an "executive" I found myself often focused on issues of "alignment,". I know, booorring, right? Well, as an org grows, this is just an unfortunate reality. Communication is hard to scale and people begin to operate on fractured sets of assumptions. Trying to fix it turns out to be one of the highest leverage things you can do. In my experience, I found there is often little disagreement on *what* the problems are, but plenty of disagreement on *which* were more important. People then carry these differences into decision making without revealing their working assumptions. Cascading tradeoffs are made and efforts diverge. There was an incredible sense of clarity when everyone could agree on what's most important in unison, and I wanted to get there.
...
I've since turned the process into a [Google Sheet](https://docs.google.com/spreadsheets/d/1BYh9ZtEv4k7xoSXmtf1qCP8bYHBCZLEuTVHsTDPQM1M/edit?gid=2033972304#gid=2033972304). Try it at work or in your personal life!